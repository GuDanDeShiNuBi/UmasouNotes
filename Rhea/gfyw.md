...
教师账号（用来查看成绩）：tea0609   密码：123456
学生账号：stu0609  密码：123456
06.25号关闭该试用账号 
已关闭

- 20250620 
更新到 光伏电站虚拟仿真实训系统V1.3版本
修改了：
关闭软件或者退出软件，账号未退出问题
在原有的万维程序类Action_Quit中添加了数据库账号退出的程序，循环调用2次，0.5后关闭软件
在训练、巡检、考试模式中均添加了软件非正常关闭时进行账号退出的程序，ApplicitionQuit