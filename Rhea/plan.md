...
- 光伏e站通
  - 将并网软件内名称标题和图片修改，重新打包发布

- 能量管理调度系统
  - 将能源微网3D软件中AI能源调度和AI问答单独提出来作为一个软件
  - 包含账号登录功能，在原本数据库中增加了user_nydd表，用来用户账号管理，去除原本的mac绑定，需手动在数据库添加账号
  - 加入deepseek
  - 将界面修改再做一版，用于竞赛部门使用
  - 独立的这一版对能源调度模块进行了优化

20250904
- 一个月后（20251004），3d仿真规划投标软件 账号删除：xxdltea  密码：123456   已删除

20251027
- 11月23江西机电的训练账号删除，新型电力两个软件  xltea01~50   xlstu01~50

20251117 
- 淮安技师  新型电力两个软件 15天后账号删除